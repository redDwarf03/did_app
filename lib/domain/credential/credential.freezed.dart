...
class _$CredentialPresentationCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    Object? type = null,
    Object? holder = null,
    Object? verifiableCredentials = freezed,
    Object? revealedAttributes = freezed,
    ...
    return _then(_value.copyWith(
      ...
      holder: null == holder
          ...
          : holder // ignore: cast_nullable_to_non_nullable
              as String,
      verifiableCredentials: freezed == verifiableCredentials
          ? _value.verifiableCredentials
          : verifiableCredentials // ignore: cast_nullable_to_non_nullable
              as List<Credential>?,
      revealedAttributes: freezed == revealedAttributes
...
/// @nodoc
@JsonSerializable()
class _$CredentialPresentationImpl extends _CredentialPresentation
  ...
  @JsonKey(name: 'verifiableCredential')
  List<Credential>? get verifiableCredentials {
    final value = _verifiableCredentials;
    if (value == null) return null;
  ...
  @override
  Map<String, List<String>>? get revealedAttributes {
    final value = _revealedAttributes;
    if (value == null) return null;
...
// W3C allows object or array
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CredentialPresentation(context: $context, id: $id, type: $type, holder: $holder, verifiableCredentials: $verifiableCredentials, revealedAttributes: $revealedAttributes, predicates: $predicates, proof: $proof, created: $created, challenge: $challenge, domain: $domain)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('id', id))
      ..add(DiagnosticsProperty('type', type))
      ..add(DiagnosticsProperty('holder', holder))
      ...
      ..add(DiagnosticsProperty('predicates', predicates))
      ..add(DiagnosticsProperty('proof', proof))
...
abstract class _CredentialPresentation extends CredentialPresentation {
  const factory _CredentialPresentation(
      ...
      final DateTime? created,
      final String? challenge,
      final String? domain}) = _$CredentialPresentationImpl;
  const _CredentialPresentation._() : super._();
